...
public class SwerveParser_RBSI {
  ...
  /** Array holding the module jsons given in {@link SwerveDriveJson_RBSI}. */
   ...
   */
  public SwerveParser_RBSI(File directory) throws IOException {
    checkDirectory(directory);
    swerveDriveJson =
        new ObjectMapper()
            .readValue(new File(directory, "swervedrive.json"), SwerveDriveJson_RBSI.class);
