...
public class DeviceJson_RBSI {
  ...
  public SwerveAbsoluteEncoder createEncoder(SwerveMotor motor) {
    ...
    switch (type) {
      ...
      case "cancoder":
        return new CANCoderSwerve_RBSI(id, canbus != null ? canbus : "");
      default:
  ...
  public SwerveIMU createIMU() {
    ...
    switch (type) {
      ...
      case "pigeon2":
        return new Pigeon2Swerve_RBSI(id, canbus != null ? canbus : "");
      default:
  ...
  public SwerveMotor createMotor(boolean isDriveMotor) {
    ...
    switch (type) {
      ...
      case "kraken":
      case "talonfx":
        return new TalonFXSwerve_RBSI(id, canbus != null ? canbus : "", isDriveMotor);
      case "talonsrx":
