...
public class TalonFXSwerve_RBSI extends SwerveMotor {
   ...
   */
  public TalonFXSwerve_RBSI(TalonFX motor, boolean isDriveMotor) {
   ...
   */
  public TalonFXSwerve_RBSI(int id, String canbus, boolean isDriveMotor) {
